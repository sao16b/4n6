...
### 1. Ident (Baby - 100 points) - What is the Apple ID used on the imaged iPhone?

In `/private/var/mobile/Library/Accounts/Accounts3.sqlite`{: .filepath} there's information about the phone's accounts in the ZACCOUNT table. Here there are records indicating an iCloud account **billthemegakill@icloud.com**.

![Accounts3.sqlite](/assets/img/2024-04-07/1_1.png){: width="600" }

### 2. Namedrop (Baby - 100 points) - What is the iPhone owner's full name?

In `/private/var/mobile/Library/AddressBook/AddressBook.sqlitedb`{: .filepath}, I stumbled on the owner's name in the ABPerson table: **William Phorger**.

![AddressBook.sqlitedb](/assets/img/2024-04-07/2_1.png){: width="400" }

### 3. Conspirators (Warmup - 100 points) - Which Telegram accounts did the owner discuss shady stuff with?
...
### 4. Visit (Tricky - 127 points) - Where does William live?
...
### 5. Username (Baby - 100 points) - What is the username of the laptop user?
...
### 6. April Paycheck (Warmup - 208 points) - What is the amount of William's first take in April?
...
Back in the Windows image, in Data Artifacts -> Recent Documents, I see a couple LNK files for some PNG files in `C:\Users\phorger\Pictures`{: .filepath}. There, `Capture2.png`{: .filepath} shows some transactions.
...
### 7. Party (Tricky - 643 points) - Where did the gang go to celebrate their success together in March?
...
### 8. Crypto (Warmup - 286 points) - Which file does the guy keep his encrypted container in?
...
### 9. Luxury (Warmup - 357 points) - Which luxurious item did Phorger put his laundered money into?
...
### 10. Vacation (Tricky - 603 points) - Which concert were Phorger and his girlfriend planning to attend in May?
...
### 11. Illustrator (Warmup - 438 points) - What's the name of the person who designed the print template for the bills?
...
### 12. Homebrew Lab (Tricky - 438 points) - Where is the makeshift lab where they printed the cash located?
...
However, there are a few places to find location data on the iPhone. One of them is in `/private/var/root/Library/Caches/locationd/consolidated.db`{: .filepath}. In the GeoFences table, there's one entry for 38.5924436, -90.057325.
...
### 13. Largest Batch (Warmup - 315 points) - What is the precise moment their largest printing batch was completed?
...
### 14. Device (Tricky - 357 points) - What's the printer model they used to print money?

On the Windows image in Autopsy, there are entries under Data Artifacts -> USB Device Attached for an **HP LaserJet M1132 MFP**; this information was pulled from the `SYSTEM`{: .filepath} registry hive.

![USB Device Attached](/assets/img/2024-04-07/14_1.png){: width="500" }

### 15. Night Shift (Tricky - 579 points) - Which ATM did Phorger test his bills on recently?
...
Using the same process of decoding the timestamps as in [task 13](#13-largest-batch-warmup---315-points---what-is-the-precise-moment-their-largest-printing-batch-was-completed), the timestamps of these messages seem to indicate William visited the ATM between the night of April 1st and the morning of April 3rd; this is also verified in the task description.
...
### 16. Mole (Hard - 691 points) - Who leaked the technical data on the bill validator to the gang?
...
### 17. Financial Institution (Hard - 829 points) - Which offshore financial institution did the gang bank with?
...
On the iPhone, there's a `Shortcuts.sqlite`{: .filepath} database in `/private/var/mobile/Library/Shortcuts`{: .filepath}. In the ZSHORTCUTACTIONS table there are some interesting code snippets in the ZDATA column. The first entry contains logic for encoding data, and the second for decoding data.
...
I start decoding the rest of the hex messages from the t7 table. One of them contains the SWIFT code for the offshore bank: **CRVBPA2P**.

![Decoded SWIFT Code](/assets/img/2024-04-07/17_8.png){: width="400" }

### 18. Statement (Hard - 590 points) - Paste Phorger's entire bank statement here, containing all his offshore transactions.
