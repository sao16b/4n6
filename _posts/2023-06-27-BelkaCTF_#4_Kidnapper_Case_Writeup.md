...
### 1. Users (Baby - 100 points) - List all users of the laptop.
...
![User Folders](/assets/img/2023-06-27/1_1.png){: width="700" }

### 2. Special Web Site (Baby - 100 points) - What web application was used by this boy to earn his pocket money?
...
![Drug Store](/assets/img/2023-06-27/2_1.png){: width="400" }

### 3. Wallet (Baby - 100 points) - Which BTC wallet did the boy use to sell drugs?
...
![Bitcoin Address](/assets/img/2023-06-27/3_1.png){: width="600" }

### 4. Passme (Moderate - 500 points) - On which date does the kid's database show the most sales for "Acapulco Gold"?

The task points us to email. Stanley has a `.thunderbird`{: .filepath} folder in his home directory. Autopsy formats E-mail messages nicely so I go to Data Artifacts -> E-Mail Messages -> Default -> Default to see Stanley's emails. The latest e-mail was sent from ivstanely@yandex.com to tuxnetwork@yandex.com with the database attached.

![E-Mail Messages](/assets/img/2023-06-27/4_1.png)
...
![Acapulco Gold Sales](/assets/img/2023-06-27/4_4.png)

A quick look through the results showed Stanley/Ivan sold $16,044 in Acapulco Gold on **5/12/2021**.

### 5. Cryptlet (Tricky - 750 points) - What was the other BTC wallet of the victim, which he used to hide his "under the counter" sales from his superior?
...
![Partial Bitcoin Address](/assets/img/2023-06-27/5_1.png)
...
![101.bin Hexdump Header](/assets/img/2023-06-27/5_2.png){: width="600"}

I see %%OE.F in the footer.

![101.bin Hexdump Footer](/assets/img/2023-06-27/5_3.png){: width="600"}
...
![dd Results](/assets/img/2023-06-27/5_4.png){: width="600"}

With the endianness swapped, everything looked cleaner. I had -1.4.1 in the header.

![Post-dd 101.bin Hexdump Header](/assets/img/2023-06-27/5_5.png){: width="600"}

I had %%EOF. in the footer.

![Post-dd 101.bin Hexdump Footer](/assets/img/2023-06-27/5_6.png){: width="600"}

All that's left is to fill in the header.

![101.bin Fixed Hexdump Header](/assets/img/2023-06-27/5_7.png){: width="600"}
...
![Fixed PDF](/assets/img/2023-06-27/5_8.png){: width="500"}

### 6. Notipass (Tricky - 750 points) - What is the password to the boy's notes?
...
The task points us in the direction of containers. I thought I saw a `vmware`{: .filepath} folder somewhere...yes! `/home/stanley/.cache/vmware`{: .filepath}. Dishearteningly, I find folders with PDFs that give the answer to <a href="#5-cryptlet-tricky---750-points---what-was-the-other-btc-wallet-of-the-victim-which-he-used-to-hide-his-under-the-counter-sales-from-his-superior">task 5</a> with just a single header substitution. But there's something else! A PDF called `NOTHING_IMPORTANT_INFO.pdf`{: .filepath} with something seemingly important embedded in it (thank you Autopsy!): a file called `passwd`{: .filepath}.

![Important PDF](/assets/img/2023-06-27/6_1.png)

Exporting it and examining shows a long string of text.

![passwd](/assets/img/2023-06-27/6_2.png){: width="500"}
...
![Base32 Decode](/assets/img/2023-06-27/6_3.png){: width="500"}
...
![dcode.fr Results](/assets/img/2023-06-27/6_4.png){: width="500"}

### 7. Specudio (Hard - 1000 points) - What is the "secret pin" mentioned in the notes?
...
![Wireshark](/assets/img/2023-06-27/7_1.png)
...
![Audacity Spectrogram](/assets/img/2023-06-27/7_2.png){: width="500"}

### 8. Ultimatum (Baby - 100 points) - When did the boy receive a threat?
...
### 9. Whois (Warmup - 200 points) - Who was the kidnapper?

From the `notes`{: .filepath} file we know it's his friend **0xTux**. His email can be found back in Autopsy in Data Artifacts -> E-Mail Messages -> Default -> Default (tuxnetwork@yandex.com). Or, at least, so I thought.
...
![Sheet1.html](/assets/img/2023-06-27/8_1.png){: width="400"}

Searching for Tux gives an email: **wixelig493@keagenan.com**.

![Tux Email](/assets/img/2023-06-27/8_2.png){: width="400"}
